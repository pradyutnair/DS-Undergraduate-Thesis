...
\usepackage{graphicx}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% CUSTOM IMPORTS
% Package for including separate .text files into the main.tex without clearing page first
% % Add the geometry package for the page layout
%\usepackage[left=3.12cm, right=3.12cm, top=2.4cm, bottom=2.4cm]{geometry}
%all the other includes etc. are done in the thesis.sty file.
\usepackage{thesis}


\newcommand{\doctitle}{Generalization Perspective}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{abstract}
\pagenumbering{roman}
\textsf{Write an abstract for your work. Replace each of the points below with one sentence (two if you must) and you have your abstract. Write it when you finished your entire report.}
...
\include*{3_Problem Exposition/problem_exposition}
